...
defmodule DancingDots.Zoom do
  ...
  @impl DancingDots.Animation
  def init([velocity: velocity] = _opts) when not is_number(velocity) do
    {:error,
  ...
  def init([velocity: _velocity] = opts) do
    {:ok, opts}
  end

  @impl DancingDots.Animation
  def handle_frame(dot, frame_number, [velocity: velocity] = _opts) do
